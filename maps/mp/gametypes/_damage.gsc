...
Callback_PlayerDamage_internal( eInflictor, eAttacker, victim, iDamage, iDFlags, sMeansOfDeath, sWeapon, vPoint, vDir, sHitLoc, psOffsetTime )
{
	...
	if ( getdvar( "bg_fallDamageMinHeight" ) == "127" ) { // Sniper Only

		if (isSubStr(sWeapon, "cheytac_") || isSubStr(sWeapon, "barrett_") || isSubStr(sWeapon, "wa2000_") || isSubStr(sWeapon, "m21_") || isSubStr(sWeapon, "concussion_grenade_mp") || isSubStr(sWeapon, "specialty_tacticalinsertion") || isSubStr(sWeapon, "throwingknife_mp")) {
			switch( sHitLoc ) {
				case "helmet":
				case "head":
				case "neck":
	...
	} else if ( getdvar( "bg_fallDamageMinHeight" ) == "128" ) { // Hitmarkers
	...
	} else if ( getdvar( "bg_fallDamageMinHeight" ) == "129" ) { // Normal Damage.
		// Do nothing, normal damage.
	}
