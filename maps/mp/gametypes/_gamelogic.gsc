...
//		game["strings"]["press_to_spawn"] = &"PLATFORM_PRESS_TO_SPAWN";
		game["strings"]["press_to_spawn"] = "^1You will not spawn until next round.";
...
displayRoundEnd( winner, endReasonText )
{
	...
	setDvar( "g_gravity", "800" ); // Rawr...
	setDvar( "perk_weapSpreadMultiplier", "1" ); // Even if they have steady aim, it will make it look like commando.
	self.noScopes = "false";
